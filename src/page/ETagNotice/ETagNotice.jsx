...
import ETCNotice_Table from './ETagNotice_Table.jsx'
import Form_BoatNotice_Table2 from './ETagNotice_Table2.jsx'
    ...
    return (
        <Form id="Form_boat1" className="container">
            <div className="row justify-content-center col-12">
                <Card >
                    {/* ======== card title ======= */}
                    <div className="divCardTitle" >平面ETag注偵設定</div>
                    <Card.Body className="col-12">
                        ...
                        <ETCNotice_Table></ETCNotice_Table>

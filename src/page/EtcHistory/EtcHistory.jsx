...
import Form_BoatNotice_Table from './EtcHistory_Table.jsx'
import Form_BoatNotice_Table2 from './EtcHistory_Table2.jsx'
    ...
    return (
        <Form id="Form_boat1" className="container">
            <div className="row justify-content-center col-12">
                <Card >
                    {/* ======== card title ======= */}
                    <div className="divCardTitle" >ETC行車紀錄(本案已查詢歷史紀錄)</div>

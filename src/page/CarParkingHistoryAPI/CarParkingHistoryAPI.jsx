...
import Form_BoatNotice_Table from './CarParkingHistoryAPI_Table.jsx'
import Form_BoatNotice_Table2 from './CarParkingHistoryAPI_Table2.jsx'
    ...
    return (
        <Form id="Form_boat1" className="container">
            <div className="row justify-content-center col-12">
                <Card >
                    {/* ======== card title ======= */}
                    <div className="divCardTitle" >停車紀錄(拋查)</div>

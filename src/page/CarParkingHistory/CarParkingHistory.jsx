...
import './CarParkingHistory.scss'
// import { ThemeProvider, StylesProvider, jssPreset, makeStyles, createStyles } from '@material-ui/core/styles'
import Form_BoatNotice_Table from './CarParkingHistory_Table.jsx'
import Form_BoatNotice_Table2 from './CarParkingHistory_Table2.jsx'
    ...
    return (
        <Form id="Form_boat1" className="container">
            <div className="row justify-content-center col-12">
                <Card >
                    {/* ======== card title ======= */}
                    <div className="divCardTitle" >停車紀錄(本案已查詢歷史紀錄)</div>
            ...
            <Modal show={show} onHide={handleClose} size="lg"
                ...
                <Modal.Header closeButton>
                    <Modal.Title>新增注偵停車車輛</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <InputGroup className="mb-3">
